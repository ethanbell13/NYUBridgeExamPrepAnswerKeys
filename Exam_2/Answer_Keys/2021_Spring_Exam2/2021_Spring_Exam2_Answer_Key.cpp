/*
    ...
    X = 1, p(x) = 1/9
    X = 2, p(x) = (1/27) * (1/9)
    X = 3, p(x) = (1/27) * (1/27) * (1/9)
    X = 4, p(x) = 1/36

    Distribution: {(1, 1/9), (2, 1/(27*9)), (3, 1/(27*27*9)), (4, 1/36)}

    E[X] = 1*(1/9) + 2*(1/27)*(1/9) + 3*(1/27)*(1/27)*(1/9) + 4*(1/36)
         = 1/9 + 2/(27*9) + 3/(27*27*9) + 1/9
         = 2/9 + 2/(27*9) + 3/(27*27*9)
         = (2*27 + 2)/(27*9) + 3(27*27*9)
    E[X] = (56*27 + 3)/(27*27*9)
    ...
    T(n) = Theta((lg(log(n))+1)(log(n))) = Theta(log(n)lg(log(n)))
